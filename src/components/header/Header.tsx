...
export function Header() {
	...
	return (
		<header className='bg-card sm:px-mini-element xs:flex-col xs:pb-4 absolute top-7 left-1/2 z-10 flex w-4/12 -translate-x-1/2 items-center justify-between rounded-xl p-2 px-5 shadow-xl sm:rounded-sm xl:relative xl:top-0 xl:mb-5 xl:w-full'>
